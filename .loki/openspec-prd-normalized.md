# OpenSpec Change: window-management-redesign
...
### window-management: Content-Tight Window Sizing [MODIFIED]
...
### window-management: Transparent Window Preservation [MODIFIED]
...
### window-management: Remove Click-Through Toggle Mechanism [MODIFIED]
...
### window-management: Native Drag via CSS Classes [MODIFIED]
...
### window-management: Remove data-clui-ui Attribute [MODIFIED]
...
### window-management: Anchor-Based Position Tracking [MODIFIED]
...
### window-management: Display Detection via Bounds Matching [MODIFIED]
...
### window-management: isDragging Guard [MODIFIED]
...
### window-management: Force-Expand on Beat Check [MODIFIED]
...
### window-management: Native macOS Shadow [MODIFIED]
...
### window-management: Window Creation Settings [MODIFIED]
...
### window-management: showWindow Positioning Update [MODIFIED]
...
### window-management: Update CLAUDE.md Section 4 [MODIFIED]
...
### window-management: Fixed Canvas Sizing [REMOVED]
...
(Deprecated: The comment block explaining the rationale for fixed-canvas ("Dynamic setBounds() causes: click-through math errors, movability loss, display-scaling drift") no longer applies because click-through is being removed entirely)
...
### window-management: Click-Through IPC Handler [REMOVED]
...
(Deprecated: The corresponding preload bridge method `setIgnoreMouseEvents` is removed)
...
(Deprecated: and replaced by a functional handler (see MODIFIED Requirement: Content-Tight Window Sizing))
